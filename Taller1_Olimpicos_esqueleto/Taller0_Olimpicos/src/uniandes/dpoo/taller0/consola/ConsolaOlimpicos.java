...
public class ConsolaOlimpicos
{
		...
		while (continuar)
		{
			try
			{
				...
				if (opcion_seleccionada == 1)
					...
					ejecutarConsultarPaisAtleta(); //MODIFICACION 1
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país que representa un atleta"); //MODIFICACION 1
	 ...
	 */
	private void ejecutarConsultarPaisAtleta()
	{
		System.out.println("\n" + "Consultar el pais que representa un atleta" + "\n");
		...
		try
		{
			...
			if (pais != null)
			{
				...
				System.out.println("No fue posible consultar el pais del atleta " + atleta);
				}
		}
		catch (NumberFormatException nfe)
		{
			System.out.println("El atleta ingresado no es válido. Por favor intente de nuevo.");
		}
	}
